...
def parse_arguments():
    ...
    parser.add_argument("-cs", "--connection_string_source", help="COSMOSDB Connection String for Source")
    parser.add_argument(
    ...
    parser.add_argument("-ct", "--connection_string_target", help="COSMOSDB Connection String for Target")
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    CosmosDBService.replace_all(source_db, target_db)
